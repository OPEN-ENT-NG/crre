...
import fr.openent.crre.service.impl.DefaultTitleService;
...
public class TitleController extends ControllerHelper {
    ...
    public TitleController(Vertx vertx, EventBus eb) {
        super();
        titleService = new DefaultTitleService(Crre.crreSchema, "title");
        structureService = new DefaultStructureService(Crre.crreSchema);
