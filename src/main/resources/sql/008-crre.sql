...
VALUES (1, 'Type numérique', 'credits', false, 'Catalogue numérique', false, '[{"libelle":"Numériques"}, {"libelle":"Mixtes"}]'),
       ...
       (6, 'Type consommable pro numérique et papier', 'consumable_credits', false, 'Catalogue consommable Pro', false, '[{"libelle":"Numériques"}, {"libelle":"Mixtes"}, {"libelle": "Établissements professionnels"}, {"libelle":"Établissements polyvalents"}]'),
       (7, 'Type Pro papier', 'credits', false, 'Catalogue papier Pro', false, '[{"libelle":"Papier"}, {"libelle": "Établissements professionnels"}, {"libelle":"Mixtes"}, {"libelle":"Établissements polyvalents"}]');